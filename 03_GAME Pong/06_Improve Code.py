...
class GameManager:
    ...
    def draw_score(self):
        ...
        opponent_score_rect = opponent_score.get_rect(midleft = (screen_width/2 - 60, screen_height/2))        
...
# 08 #
# Game Objects ====================================
player = Player('graphics/Paddle.png', screen_width -20, screen_height/2, 10)
opponent = Opponent('graphics/Paddle.png', 20, screen_width/2, 15)
...
while True:
    ...
    pygame.display.flip()
    clock.tick(60)
    pygame.display.set_caption(f'{game_name}   FPS: {clock.get_fps() :.0f}')
