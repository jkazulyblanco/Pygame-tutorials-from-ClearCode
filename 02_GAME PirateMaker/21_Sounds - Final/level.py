...
class Level:
    ...
    def build_level(self, grid, asset_dict, jump_sound):
        for layer_name, layer in grid.items():
            for pos, data in layer.items():
                ...
                match data:
                    # collision_sprites in this case only tell to player the others collisions
    ...
    def get_coins(self):
        ...
        for sprite in collided_coins:
            ...
            # if sprite.coin_type == 'gold': # use this to create a value for coins
            #     print('gold, you earn 100 pts')
