...
class UI:
    ...
    def weapon_overlay(self, weapon_index, has_switched):
        bg_rect = self.selection_box(10, 630, has_switched) # weapon bg
        weapon_surf = self.weapon_graphics[weapon_index]
        weapon_rect = weapon_surf.get_rect(center= bg_rect.center)
        self.display_surface.blit(weapon_surf, weapon_rect)
    
    def magic_overlay(self, magic_index, has_switched):
        bg_rect = self.selection_box(80, 635, has_switched) # magic bg
    ...
    def display(self, player):
        ...
        self.weapon_overlay(player.weapon_index, player.hightligh_weapon)
        self.magic_overlay(player.magic_index, player.hightligh_magic)